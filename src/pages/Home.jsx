  ...
  return (
    ...
    <div className="mainContainer">
      ...
      {/* onClick={()=>router.push('/Results')} */}
        <Button onClick={handleSearch}  className="btn1">Google Search</Button>
